...
:: HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Power\EnergyEstimation\TaggedEnergy --> [Computer\HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Power]
:: ------------------------------------------------------------------------------------------------------------------------------------------------
