...
REM ; îò iosiph-a ñ ëþáîâüþ æè åñ
...
REM ; îò iosiph-a ñ ëþáîâüþ æè åñ
REM ; Îòêëþ÷èòü áûñòðûé çàïóñê
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Power" /v "HiberbootEnabled" /t REG_DWORD /d "0" /f
REM ; Îòêëþ÷åíèå ãèáåðíàöèè
...
REM ; îò iosiph-a ñ ëþáîâüþ æè åñ
REM ; Íå áóäóò óñòàíàâëèâàòüñÿ ïðèëîæåíèÿ ñî Store
REM ; áóäóò ïðîáëåìû íàïðèìåð ñ óñòàíîâêîé ïàíåëÿ óïðàâëåíèÿ nvidia ïðè ïåðåóñòàíîâêå äðàéâåðà
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\ClipSVC" /v "Start" /t REG_DWORD /d "4" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\SecurityHealthService" /v "Start" /t REG_DWORD /d "4" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\wscsvc" /v "Start" /t REG_DWORD /d "4" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\mpssvc" /v "Start" /t REG_DWORD /d "4" /f
...
rem ¢ëàã¡ ¥â á¨áâ¥¬­ë¥ ¯à®æ¥ááë ª®â®àë¥ á«¥¤ïâ §  ­ ª®¯¨â¥«ï¬¨.
rem ¥á«¨ á ¬ ¤¥« ¥èì ®¯â¨¬¨§ æ¨î ¨ á«¥¤¨èì §  á¢®¨¬¨ ¤¨áª ¬¨ â® ¬®¦¥èì ¢ëª«îç¨âì
...
REM ; FSO - fullscreen optimizations - ïîëíîýêðàííàÿ îïòèìèçàöèÿ
...
REM ; îò iosiph-a ñ ëþáîâüþ æè åñ
REM ; Êà÷åñòâî ôîíà ðàáî÷åãî ñòîëà íà ñîòêó æè åñ
...
REM ; îòêëþ÷åíèå Meltdown è Spectre
...
REM ; îò iosiph-a ñ ëþáîâüþ æè åñ
REM ; îòêëþ÷åíèå ðåçåðâà 20% CPU äëÿ ôîíîâûõ ïðîöåññîâ (âðîäå áåç ðàçíèöû, íî âñå ðàâíî)
...
ï»¿reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Search" /v "AllowCortana" /t REG_DWORD /d 0 /f 
...
echo Made by ios1ph
echo Žâª«îç¥­¨¥ HDCP ®â ¨­â¥£à¨à®¢ ­­®© ª àâë INTEL
...
REM ; îò iosiph-a ñ ëþáîâüþ æè åñ
REM ; îòêëþ÷èòü àâòîîáíîâëåíèå ïðèëîæåíèé ñòîð (÷òîáû íå âêëþ÷àëîñü íèêîãäà)
...
ï»¿reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\DataCollection" /v AllowTelemetry /t REG_DWORD /d 0 /f 
...
ï»¿reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" /v "ShowRecent" /t REG_DWORD /d 0 /f 
...
ï»¿schtasks /end /tn "\Microsoft\Windows\FileHistory\File History (maintenance mode)"
...
REM ; îò iosiph-à ñ ëþáîâüþ æè åñ
Reg.exe add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\AdvertisingInfo" /v "Enabled" /t REG_DWORD /d "0" /f
...
ï»¿net stop DiagTrack
sc config DiagTrack start=disabled


echo Made by ios1ph
echo Žâª«îç¥­¨¥ âà¨££¥à®¢ ¢ ¯« ­¨à®¢é¨ª¥ § ¤ ç...
...
REM ; îò iosiph-a ñ äþáîâüþ æè åñ
...
REM ; Ñòàðîå ìåíþ ïèòàíèå êàê â windows 7
...
REM ; îò iosiph-a ñ ëþáîâüþ æè åñ
REM ; óâåëè÷åíèå ñèñòåìíîãî êýøà. Ïîâûøàåò ñêîðîñòü HDD.
REM ; äëÿ HDD þçåðîâ ìîæåò áûòü ïðèáàâëåíèå ê ÔÏÑ
...
REM ; îò iosiph-a ñ ëþáîâüþ æè åñ
REM ; óìåíüøåíèå âðåìåíè îòêëþ÷åíèÿ ïðîöåññîâ è ïîêàçà ìåíþ
...
REM ;Óñêîðèòü îòêëèê êëàâèàòóðû
REM ;Â èãðàõ áûñòðåå ðåàãèðóåò íà íàæàòèÿ - ñòàíîâèòñÿ ïðèÿòíåå ïåðåìåùàòüñÿ
REM ;Â èãðå Dragon's Dogma: Dark Arisen çàìå÷åíî çàëèïàíèå êëàâèø
...
REM ; îò iosiph-a ñ ëþáîâüþ æè åñ
REM ; óìåíüøåíèå âðåìåíè ïðè çàâåðøåíèè ðàáîòû äëÿ ñîõðàíåíèÿ äàííûõ
REM ; ïî óìîë÷àíèþ ñòîèò "12000" òîåñòü 12 ñåêóíä
