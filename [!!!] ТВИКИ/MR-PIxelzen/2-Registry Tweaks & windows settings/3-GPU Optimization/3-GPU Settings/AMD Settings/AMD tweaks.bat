...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\amdlog" /v "FlipQueueSize" /t REG_BINARY /d "3000" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\amdlog" /v "Main3D_DEF" /t REG_SZ /d "1" /f
Exit
