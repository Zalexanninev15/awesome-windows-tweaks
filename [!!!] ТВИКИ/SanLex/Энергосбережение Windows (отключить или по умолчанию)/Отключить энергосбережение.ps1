...
# Duplicate Ultimate Performance power scheme, customize it and make it the power scheme
...
powercfg /changename scheme_current "Power Scheme" "Power scheme optimized for optimal latency and performance."
