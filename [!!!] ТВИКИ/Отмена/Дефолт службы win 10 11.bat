...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\LSM" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\NetSetupSvc" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\VBoxService" /v "Start" /t REG_DWORD /d "2" /f
