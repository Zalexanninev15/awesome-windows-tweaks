...
pwsh -CommandWithArgs "scoop install adb far vivaldi apktool cacert vscode localsend jexiftoolgui cmake copyq extras/ayugram cowsay privacy.sexy handbrake cpufetch cygwin dark devd dnspyex windows-terminal DS4Windows fastfetch hugo-extended hokus ffmpeg github goggalaxy gpg exiftool epic-games-launcher fastfetch grep hashcheck obsidian nilesoft-shell heroic-games-launcher insomnia jcpicker kryptor masscode mc micro mingw minisign nextcloud nmap notion oh-my-posh painter pycharm resource-hacker Responsively sandboxie-plus-np screentogif jcpicker simplenote SQLiteStudio staxrip python steam-achievement-manager ttyd rustrover ventoy vhs wget windhawk z webcopy autohotkey python docker"
pause
